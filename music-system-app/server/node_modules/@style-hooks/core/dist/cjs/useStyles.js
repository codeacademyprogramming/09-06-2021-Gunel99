...
exports.useStyles = exports.parseValue = exports.splitValue = exports.getBreakpointOrder = void 0
...
const getBreakpointOrder = (0, _utils.fastMemoize)(
  'breakpointOrder',
  breakpoints => Object.keys(breakpoints),
  WeakMap
)
exports.getBreakpointOrder = getBreakpointOrder
const splitWs = /(?!\[.*)\s+(?![^[]*?\])/g,
  replaceWs = /^\s+|\s+$|\s+(?=\s)/g

const splitValue = value => value.replace(replaceWs, '').split(splitWs)

exports.splitValue = splitValue

const parseValue = (originalValue, theme) => {
  let indexOfSplit = originalValue.indexOf(theme.breakpointsDelimiter),
    value = originalValue,
    breakpoint = null // handles breakpoint splitting
  ...
  if (value.indexOf('[') === 0 && value.indexOf(']') === value.length - 1)
    value = value.substring(1, value.length - 1) // empty values are treated as bools
  ...
  if (mediaQueries !== void 0) {
    ...
    for (i = 0; i < breakpoints.length; i++) {
      ...
      if (mediaQueries[breakpoint] !== void 0) {
        css.push(
          _core.css`@media ${theme.breakpoints[breakpoint]}{${mediaQueries[breakpoint]};}`
        )
      }
    }
  }
...
const getKind = (kinds, kind) =>
  ...
  withoutStyles = (0, _trieMemoize.default)([Map], styles =>
    Object.assign(
      {
        kind: 0,
      },
...
const useStyles = (name, styles, props) => {
  ...
  let theme = (0, _ThemeContext.useTheme)(),
  ...
  if (kind !== void 0 && kind.css !== void 0) {
    ...
    kind = (0, _utils.objectWithoutPropsMemo)(kind, withoutCssProp)
  }
  ...
  if (defaultProps !== void 0 && defaultProps.css !== void 0) {
    defaultPropsCss = Array.isArray(defaultProps.css)
      ...
      : defaultProps.css
    defaultProps = (0, _utils.objectWithoutPropsMemo)(
      defaultProps,
      withoutCssProp
    )
  }
  ...
  nextProps =
    styleProps === void 0
      ...
      : (0, _utils.objectWithoutProps)(nextProps, styleProps)
