...
exports.Slide = exports.useSlide = void 0
...
function _ref(props) {
  return (0, _core.useStyles)('slide', styles, props)
}

const useSlide = props =>
    (0, _useToggleVisibility.default)(
      _ref,
      _extends(
        {
  ...
  Slide = (0, _createRenderProp.default)(useSlide)
